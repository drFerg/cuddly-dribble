...
\subsubsection{Optimisations/Compression} % (fold)
...
\TODO{Discuss the use of state change optimisations and compression}
...
\TODO{Describe chunking concept, use of chunks to reduce in memory size of recording}
\begin{figure}[ht]
\centering
